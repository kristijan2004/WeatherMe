WeatherMe is my first Javascript web application where I am using the OpenWeather API to fetch the cities weather information and display them into the browser.
